...
/*
        ...
        sUriMatcher.addURI(ItemContract.CONTENT_AUTHORITY, ItemContract.PATH_RINGS + "*/
/*", RING_ID);
...
/*
        ...
        sUriMatcher.addURI(ItemContract.CONTENT_AUTHORITY, ItemContract.PATH_BANGLES + "*/
/*", BANGLE_ID);
...
/*
        ...
        sUriMatcher.addURI(ItemContract.CONTENT_AUTHORITY, ItemContract.PATH_CHAINS + "*/
/*", CHAIN_ID);
...
/*
        ...
        sUriMatcher.addURI(ItemContract.CONTENT_AUTHORITY, ItemContract.PATH_NECKLACES + "*/
/*", NECKLACE_ID);
